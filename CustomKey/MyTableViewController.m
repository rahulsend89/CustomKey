...
- (void)insertNewObject:(id)sender {
    [[MyModal sharedInstance] insertNewObject:sender];
}
...
{
    [[MyModal sharedInstance] fetchedResultsController].delegate = self;
    return [[MyModal sharedInstance] fetchedResultsController];
}
